...
/**
 * struct list_s - linked listherjkfne of variables
 * @value: valuehfnkejfv
 * @next: pointer erhfto nextmfl node
**/
...
/**
 * struct built_s - linked lkrf,lf,ist of builrfatins
 * @name: name ofmlwkfmf builtin
 * @p: pointer uerto funmfakaction
**/
